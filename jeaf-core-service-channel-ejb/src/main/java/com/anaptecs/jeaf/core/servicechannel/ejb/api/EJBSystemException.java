...
/**
 * System exception that is internally used by JEAF in order to indicate technical problems that occur when executing
 * operations such as lookups or method calls on EJBs.
 * 
 * @author Tillmann Schall (TLS)
 * @version $LastChangedRevision: 1431 $
 * 
 * @see com.anaptecs.jeaf.xfun.api.errorhandling.SystemException
 */
public class EJBSystemException extends SystemException {
  /**
   ...
   */
  public EJBSystemException( ErrorCode pErrorCode ) {
    super(pErrorCode);
  }
   ...
   * null.
   */
  public EJBSystemException( ErrorCode pErrorCode, String... pMessageParameters ) {
   ...
   */
  public EJBSystemException( ErrorCode pErrorCode, Throwable pCause ) {
   ...
   * null.
   */
  public EJBSystemException( ErrorCode pErrorCode, Throwable pCause, String... pMessageParameters ) {
