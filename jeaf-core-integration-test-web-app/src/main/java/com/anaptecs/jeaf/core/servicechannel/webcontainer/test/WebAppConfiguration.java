 ...
 * All rights reserved.
 */
package com.anaptecs.jeaf.core.servicechannel.webcontainer.test;
...
@AppInfo(applicationID = "JEAFCoreIntegrationTestWebApp", applicationName = "JEAF Core Integration Test Web App")
