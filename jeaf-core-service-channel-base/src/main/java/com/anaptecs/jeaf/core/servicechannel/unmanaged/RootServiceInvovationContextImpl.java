 ...
 * @version 1.0
 */
final class RootServiceInvovationContextImpl extends ServiceInvocationContext {
  /**
   * Serial Version UID
   */
   ...
   */
  RootServiceInvovationContextImpl( Class<? extends Service> pTargetServiceClass, Component pComponent,
