 ...
 */
	...
	/**
	 * Class implements builder to create a new instance of class IdentifiableServiceObjectWithMethod. As the class has readonly attributes
	...
	public static class Builder extends IdentifiableServiceObjectWithMethod.BuilderBase {
	  ...
	  /**
	   * Use {@link #newBuilder(IdentifiableServiceObjectWithMethod)} instead of protected constructor to create new builder.
	   */
