...
*/
	...
	/**
	 * Class implements builder to create a new instance of class CompositeID. As the class has readonly attributes
	...
	public static class Builder extends CompositeID.BuilderBase {
	  ...
	  protected Builder( CompositeID pObject ) {
	    super(pObject);
		   ...
		   * @return {@link CompositeID} Instance of this class as it was deserialized from the passed string. The method must not return null.
		   */
