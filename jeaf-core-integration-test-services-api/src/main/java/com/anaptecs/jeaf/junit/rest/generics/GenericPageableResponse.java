...
*/
	...
	/**
	 * Class implements builder to create a new instance of class GenericPageableResponse. As the class has readonly attributes
	...
	public static class Builder<T> extends GenericPageableResponse.BuilderBase<T> {
	  ...
	  /**
	   * Use {@link GenericPageableResponse#builder(GenericPageableResponse)} instead of protected constructor to create new builder.
	   */
