...
*/
	...
	/**
	 * Class implements builder to create a new instance of class VersionedObjectSoftLink. As the class has readonly attributes
	...
	public static class Builder extends VersionedObjectSoftLink.BuilderBase {
	  ...
	  /**
	   * Use {@link VersionedObjectSoftLink#builder(VersionedObjectSoftLink)} instead of protected constructor to create new builder.
	   */
	  protected Builder( VersionedObjectSoftLink pObject ) {
	    super(pObject);
		   ...
		   * @return {@link VersionedObjectSoftLink} Instance of this class as it was deserialized from the passed string. The method must not return null.
		   */
